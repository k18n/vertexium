...
public class InMemoryExtendedDataRow extends ExtendedDataRowBase {
    ...
    public boolean canRead(VisibilityEvaluator visibilityEvaluator, FetchHints fetchHints) {
        ...
        try {
            if (!fetchHints.isIgnoreAdditionalVisibilities() && !canReadAdditionVisibility(visibilityEvaluator)) {
                return false;
            }
    ...
    private boolean canReadAdditionVisibility(VisibilityEvaluator visibilityEvaluator) {
